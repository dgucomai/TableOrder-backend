...
import dgucomai.tableorder.dto.TokenUpdateReqDto;
...
public class TokenController {
  ...
  public ResponseEntity<Map<String, Object>> updateTokenCount(
      @PathVariable Long tableId, @RequestBody TokenUpdateReqDto request) {

    TokenUpdateResDto response = tokenService.updateTokenCount(tableId, request.delta());

    Map<String, Object> customResponse = new LinkedHashMap<>();
    customResponse.put("success", true);
    customResponse.put("code", "TOKEN_UPDATED");
    customResponse.put("message", "토큰 수량이 수정되었습니다.");
    customResponse.put("data", response);
